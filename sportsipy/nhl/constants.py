...
SCHEDULE_SCHEME = {
    "corsi_against": (
        'td[data-stat="corsi_against"]:first, td[data-stat="tm_gm_5on5_corsi_against"]:first'
    ),
    "corsi_for_percentage": (
        'td[data-stat="corsi_pct"]:first, td[data-stat="tm_gm_5on5_corsi_pct"]:first'
    ),
    "corsi_for": 'td[data-stat="corsi_for"]:first, td[data-stat="tm_5on5_corsi_for"]:first',
    "date": 'td[data-stat="date_game"]:first, td[data-stat="date"]:first',
    ...
    "fenwick_against": (
        'td[data-stat="fenwick_against"]:first, td[data-stat="tm_gm_5on5_fenwick_against"]:first'
    ),
    "fenwick_for_percentage": (
        'td[data-stat="fenwick_pct"]:first, td[data-stat="tm_gm_5on5_fenwick_pct"]:first'
    ),
    "fenwick_for": 'td[data-stat="fenwick_for"]:first, td[data-stat="tm_5on5_fenwick_for"]:first',
    "game": 'th[data-stat="games"]:first, td[data-stat="team_game_num_season"]:first',
    "goals_allowed": 'td[data-stat="opp_goals"]:first, td[data-stat="goals_against"]:first',
    "goals_scored": 'td[data-stat="goals"]:first',
    "location": 'td[data-stat="game_location"]:first',
    "offensive_zone_start_percentage": (
        'td[data-stat="zs_offense_pct"]:first, td[data-stat="tm_5on5_zs_offense_pct"]:first'
    ),
    "opp_penalties_in_minutes": (
        'td[data-stat="pen_min_opp"]:first, td[data-stat="opp_pen_min"]:first'
    ),
    ...
    "opponent_abbr": 'td[data-stat="opp_name"]:first, td[data-stat="opp_name_abbr"]:first',
    "opponent_name": 'td[data-stat="opp_name"]:first, td[data-stat="opp_name_abbr"]:first',
    "overtime": 'td[data-stat="overtimes"]:first',
    "pdo": 'td[data-stat="pdo"]:first, td[data-stat="tm_5on5_pdo_team"]:first',
...
PLAYER_SCHEME = {
    ...
    "even_strength_assists": 'td[data-stat="assists_es"], td[data-stat="assists_ev"]',
    ...
    "games_played": (
        'td[data-stat="games_played"], td[data-stat="games"], td[data-stat="goalie_games"]'
    ),
    ...
    "goals_against": 'td[data-stat="goals_against"], td[data-stat="goalie_goals_against"]',
    ...
    "height": 'div#meta p:contains("cm") span:first, span[itemprop="height"]',
    "hits_at_even_strength": 'td[data-stat="hits"]',
    "individual_corsi_for_events": 'td[data-stat="Cevents"]',
    "league": 'td[data-stat="lg_id"], td[data-stat="comp_name_abbr"]',
    "losses": 'td[data-stat="losses_goalie"], td[data-stat="goalie_losses"]',
    "minutes": 'td[data-stat="min_goalie"], td[data-stat="goalie_min"]',
    "name": 'div#meta h1 span:first, h1[itemprop="name"]',
    ...
    "quality_start_percentage": (
        'td[data-stat="quality_start_goalie_pct"], td[data-stat="quality_starts_pct"]'
    ),
    "quality_starts": 'td[data-stat="quality_starts_goalie"], td[data-stat="quality_starts"]',
    "really_bad_starts": (
        'td[data-stat="really_bad_starts_goalie"], td[data-stat="goalie_really_bad_starts"]'
    ),
    ...
    "save_percentage": 'td[data-stat="save_pct"], td[data-stat="save_pct_goalie"]',
    "saves": 'td[data-stat="saves"], td[data-stat="goalie_saves"]',
    "season": 'th[data-stat="season"], th[data-stat="year_id"]',
    ...
    "shootout_attempts": 'td[data-stat="so_att"], td[data-stat="shootouts_att"]',
    "shootout_goals": 'td[data-stat="so_made"], td[data-stat="shootouts_made"]',
    "shootout_misses": 'td[data-stat="so_miss"], td[data-stat="shootouts_miss"]',
    "shootout_percentage": 'td[data-stat="so_made_pct"], td[data-stat="shootouts_made_pct"]',
    ...
    "shots_against": 'td[data-stat="shots_against"], td[data-stat="shots_against_goalie"]',
    "shots_on_goal": 'td[data-stat="shots"]',
    "shutouts": 'td[data-stat="shutouts"], td[data-stat="goalie_shutouts"]',
    "summary": '[data-template="Partials/Teams/Summary"]',
    "takeaways": 'td[data-stat="takeaways"]',
    "team_abbreviation": 'td[data-stat="team_id"], td[data-stat="team_name_abbr"]',
    "ties_plus_overtime_loss": 'td[data-stat="ties_goalie"], td[data-stat="goalie_ties"]',
    ...
    "weight": 'div#meta p:contains("cm") span + span, span[itemprop="weight"]',
    "wins": 'td[data-stat="wins_goalie"], td[data-stat="goalie_wins"]',
}
