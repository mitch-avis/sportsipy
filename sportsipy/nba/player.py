...
from sportsipy.nba.constants import PLAYER_SCHEME
...
class AbstractPlayer:
    ...
    def _parse_value(self, stats, field):
        ...
        """
        return utils.parse_field(PLAYER_SCHEME, stats, field)
    ...
    def name(self) -> str | None:
        """Return a ``string`` of the players name, such as 'James Harden'."""
        return self._name

    @_float_property_decorator
    def minutes_played(self):
        """Return a ``float`` of the total number of minutes the player played."""
    ...
    def box_plus_minus(self):
        """Return a ``float`` of the total number of points per 100 possessions.
