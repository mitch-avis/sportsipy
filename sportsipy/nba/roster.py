...
from sportsipy.nba.constants import NATIONALITY, PLAYER_SCHEME, PLAYER_URL, ROSTER_URL
...
class Player(AbstractPlayer):
    ...
    def _parse_contract_headers(self, table: PyQuery) -> list[str]:
        ...
        """
        years = [str(i.text() or "") for i in table("th").items()]
        years.remove("Team")
        return years

    def _parse_contract_wages(self, table: PyQuery) -> list[str]:
        ...
        wages = [
            ...
            for text in (str(i.text() or "") for i in table("td").items())
        ]
        wages.remove("")
        return wages

    def _combine_contract(self, years: list[str], wages: list[str]) -> dict[str, str]:
    ...
    def team_abbreviation(self) -> str | None:
        """Return a ``string`` of the abbrevation for the team the player plays.
    ...
    def field_goals_per_poss(self):
        """Return a ``float`` of the total number of field goals the player.
    ...
    def three_pointers_per_poss(self):
        """Return a ``float`` of the total number of three point field goals the.
    ...
    def two_pointers_per_poss(self):
        """Return a ``float`` of the total number of two point field goals the.
    ...
    def free_throws_per_poss(self):
        """Return a ``float`` of the total number of free throws the player made.
    ...
    def free_throw_attempts_per_poss(self):
        """Return a ``float`` of the total number of free throws the player.
    ...
    def offensive_rebounds_per_poss(self):
        """Return a ``float`` of the total number of offensive rebounds the.
    ...
    def defensive_rebounds_per_poss(self):
        """Return a ``float`` of the total number of defensive rebounds the.
    ...
    def total_rebounds_per_poss(self):
        """Return a ``float`` of the total number of offensive and defensive.
    ...
    def assists_per_poss(self):
        """Return a ``float`` of the total number of assists the player tallied.
    ...
    def steals_per_poss(self):
        """Return a ``float`` of the total number of steals the player tallied.
    ...
    def blocks_per_poss(self):
        """Return a ``float`` of the total number of shots the player blocked.
    ...
    def turnovers_per_poss(self):
        """Return a ``float`` of the total number of times the player turned the.
    ...
    def personal_fouls_per_poss(self):
        """Return a ``float`` of the total number of personal fouls the player.
    ...
    def points_per_poss(self):
        """Return a ``float`` of the total number of points the player scored.
    ...
    def player_efficiency_rating(self):
        """Return a ``float`` of the player's efficiency rating which represents.
    ...
    def offensive_win_shares(self):
        """Return a ``float`` of the number of wins the player contributed to the.
    ...
    def offensive_box_plus_minus(self):
        """Return a ``float`` of the number of offensive points per 100.
    ...
    def defensive_box_plus_minus(self):
        """Return a ``float`` of the number of defensive points per 100.
    ...
    def value_over_replacement_player(self):
        """Return a ``float`` of the total number of points per 100 team.
    ...
    def shooting_distance(self):
        """Return a ``float`` of the average distance the player takes a shot.
    ...
    def percentage_shots_two_pointers(self):
        """Return a ``float`` of the percentage of shots the player takes that.
    ...
    def percentage_zero_to_three_footers(self):
        """Return a ``float`` of the percentage of shots the player takes from.
    ...
    def field_goal_perc_zero_to_three_feet(self):
        """Return a ``float`` of the player's field goal percentage for shots.
    ...
    def percentage_field_goals_as_dunks(self):
        """Return a ``float`` of the percentage of the player's shot attempts.
    ...
    @_int_property_decorator
    def dunks(self):
        """Return an ``int`` of the total number of dunks the player made during.
    ...
    def three_pointers_assisted_percentage(self):
        """Return a ``float`` of the percentage of 3-point field goals by the.
    ...
    def percentage_of_three_pointers_from_corner(self):
        """Return a ``float`` of the percentage of 3-point shots the player.
    ...
    def three_point_shot_percentage_from_corner(self):
        """Return a ``float`` of the percentage of 3-pointers from the corner.
    ...
    def half_court_heaves(self):
        """Return an ``int`` of the number of shots the player took from beyond.
    ...
    def half_court_heaves_made(self):
        """Return an ``int`` of the number of shots the player made from beyond.
    ...
    def point_guard_percentage(self):
        """Return an ``int`` of the percentage of time the player spent as a.
    ...
    def on_court_plus_minus(self):
        """Return a ``float`` of the number of points the player contributes to.
    ...
    def net_plus_minus(self):
        """Return a ``float`` of the net number of points the player contributes.
    ...
    def passing_turnovers(self):
        """Return an ``int`` of the total number of turnovers the player.
    ...
    def other_turnovers(self):
        """Return an ``int`` of the total number of all other non-passing/.
    ...
    def shooting_fouls(self):
        """Return an ``int`` of the total number of shooting fouls the player.
    ...
    def blocking_fouls(self):
        """Return an ``int`` of the total number of blocking fouls the player.
    ...
    def offensive_fouls(self):
        """Return an ``int`` of the total number of offensive fouls the player.
    ...
    @_int_property_decorator
    def take_fouls(self):
        """Return an ``int`` of the total number of take fouls the player.
    ...
    def points_generated_by_assists(self):
        """Return an ``int`` of the total number of points the player generated.
    ...
    @_int_property_decorator
    def and_ones(self):
        """Return an ``int`` of the total number of times the player was fouled.
    ...
    def shots_blocked(self):
        """Return an ``int`` of the total number of shots the player took that.
    ...
    @_int_property_decorator
    def salary(self):
        """Return an ``int`` of the player's annual salary rounded down."""
        return self._salary

    @property
    def contract(self) -> dict[str, str] | None:
        """Return a ``dictionary`` of the player's contract details where the key.
...
class Roster:
    ...
    def coach(self) -> str | None:
        """Return a ``string`` of the coach's name, such as "Mike D'Antoni"."""
        return self._coach
