...
from sportsipy.ncaab.constants import CONFERENCE_URL, CONFERENCES_URL
...
class Conference:
    ...
    def _get_team_abbreviation(self, team: Any) -> str:
        ...
        team_abbreviation = re.sub(r".*/cbb/schools/", "", team_href or str(name_tag))
...
class Conferences:
    ...
    def _get_conference_id(self, conference: Any) -> str:
        ...
        conference_id = re.sub(r".*/cbb/conferences/", "", conference_href or str(name_tag))
