...
from sportsipy.ncaaf.constants import BOXSCORE_RETRY, PLAYER_SCHEME
...
class AbstractPlayer:
    ...
    def extra_point_percentage(self):
        """Return a ``float`` of the percentage (0.0 to 100.0) of extra points.
    ...
    def field_goal_percentage(self):
        """Return a ``float`` of the percentage (0.0 to 100.0) of field goals.
